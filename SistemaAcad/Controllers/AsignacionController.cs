...
namespace SistemaAcad.Controllers
{
    public class AsignacionController : Controller
    {
        ...
        public AsignacionController(SistemaAcadContext context)
        {
            _context = context;
        }
        ...
        {
            var sistemaAcadContext = _context.Asignacion.Include(a => a.Curso).Include(a => a.Instructor);
            return View(await sistemaAcadContext.ToListAsync());
        }
